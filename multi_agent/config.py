...
class AgentConfig:
    ...
    ScholarMinUsefulness = 70                       # minimum usefulness score for saving google scholar papers

    XMinUsefulness = 70                             # minimum usefulness score for posting on X 
    
    
    LLM = "google"
    ModelName = "gemini-2.5-flash"                  # only ChatGoogleGenerativeAI models are supported
